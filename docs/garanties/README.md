...
### Vision stratégique long terme et droit à l'image
| Fichier | Description |
|---------|-------------|
| `Eventy-Life-Plan-Strategique-5-Ans.docx` / `.pdf` | Plan stratégique 5 ans (15 KB · 4 pages) — vision consolidée 2026 → 2031 : **3 ambitions** (volume ≥ 30 K voyages/an An 5, profitabilité 5-7 % marge nette, impact référence FR/Europe), **trajectoire chiffrée** (1 K → 30 K voyages, 16 → 480 M€ CA, 3-5 → 50-70 salariés), 4 phases (lancement An 1 → consolidation An 2 → expansion européenne An 3-4 → maturité An 5+), **6 axes transversaux** (excellence opérationnelle, transparence radicale, économie redistributive, souveraineté numérique, RSE chiffrée, communauté/chaleur), 7 risques cartographiés + mitigations, calendrier levées (Seed → pré-Série A → Série A 5-15 M€), 6 engagements stratégiques opposables |
