...
Convertit les 3 documents .docx en .pdf imprimables :
  - Eventy-Life-DPA-Sous-Traitance-RGPD
  - Eventy-Life-PV-Assemblee-Generale
  - Eventy-Life-Rapport-Gestion-Annuel

Usage : python scripts/garanties/corporate-rgpd-annuel-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-DPA-Sous-Traitance-RGPD.docx",
     "pdf":  "docs/garanties/Eventy-Life-DPA-Sous-Traitance-RGPD.pdf",
     "footer": "EVENTY LIFE SAS — DPA Sous-traitance RGPD"},
    {"docx": "docs/garanties/Eventy-Life-PV-Assemblee-Generale.docx",
     "pdf":  "docs/garanties/Eventy-Life-PV-Assemblee-Generale.pdf",
     "footer": "EVENTY LIFE SAS — PV AGOA · Modèle type"},
    {"docx": "docs/garanties/Eventy-Life-Rapport-Gestion-Annuel.docx",
     "pdf":  "docs/garanties/Eventy-Life-Rapport-Gestion-Annuel.pdf",
