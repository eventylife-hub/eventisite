...
Convertit les 3 documents .docx en .pdf imprimables :
  - Eventy-Life-Politique-Avoirs-Remboursements
  - Eventy-Life-Plan-Animation-Communaute-Famille
  - Eventy-Life-Politique-Communication-Post-Incident

Usage : python scripts/garanties/avoirs-comm-famille-post-incident-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Politique-Avoirs-Remboursements.docx",
     "pdf":  "docs/garanties/Eventy-Life-Politique-Avoirs-Remboursements.pdf",
     "footer": "EVENTY LIFE SAS — Politique avoirs et remboursements"},
    {"docx": "docs/garanties/Eventy-Life-Plan-Animation-Communaute-Famille.docx",
     "pdf":  "docs/garanties/Eventy-Life-Plan-Animation-Communaute-Famille.pdf",
     "footer": "EVENTY LIFE SAS — Plan animation communauté Famille"},
    {"docx": "docs/garanties/Eventy-Life-Politique-Communication-Post-Incident.docx",
     "pdf":  "docs/garanties/Eventy-Life-Politique-Communication-Post-Incident.pdf",
