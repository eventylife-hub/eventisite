...
Convertit les 3 documents .docx en .pdf imprimables :
  ...
  - Eventy-Life-Fiche-Sante-Voyageur
  - Eventy-Life-Document-Administratif-Voyageur

Usage : python scripts/garanties/international-securite-sante-administratif-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Consignes-Securite-Destination.docx",
     "pdf":  "docs/garanties/Eventy-Life-Consignes-Securite-Destination.pdf",
     "footer": "EVENTY LIFE SAS — Consignes sécurité destination"},
    {"docx": "docs/garanties/Eventy-Life-Fiche-Sante-Voyageur.docx",
     "pdf":  "docs/garanties/Eventy-Life-Fiche-Sante-Voyageur.pdf",
     "footer": "EVENTY LIFE SAS — Fiche santé voyageur"},
    {"docx": "docs/garanties/Eventy-Life-Document-Administratif-Voyageur.docx",
     "pdf":  "docs/garanties/Eventy-Life-Document-Administratif-Voyageur.pdf",
