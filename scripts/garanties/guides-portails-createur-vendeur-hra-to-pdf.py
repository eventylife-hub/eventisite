...
Convertit les 3 documents .docx en .pdf imprimables :
  - Eventy-Life-Guide-Portail-Createur
  - Eventy-Life-Guide-Portail-Vendeur
  - Eventy-Life-Guide-Portail-HRA

Usage : python scripts/garanties/guides-portails-createur-vendeur-hra-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Guide-Portail-Createur.docx",
     "pdf":  "docs/garanties/Eventy-Life-Guide-Portail-Createur.pdf",
     "footer": "EVENTY LIFE SAS — Guide portail créateur"},
    {"docx": "docs/garanties/Eventy-Life-Guide-Portail-Vendeur.docx",
     "pdf":  "docs/garanties/Eventy-Life-Guide-Portail-Vendeur.pdf",
     "footer": "EVENTY LIFE SAS — Guide portail vendeur"},
    {"docx": "docs/garanties/Eventy-Life-Guide-Portail-HRA.docx",
     "pdf":  "docs/garanties/Eventy-Life-Guide-Portail-HRA.pdf",
