...
Convertit les 3 documents .docx en .pdf imprimables :
  - Eventy-Life-Politique-Anti-Corruption
  - Eventy-Life-Procedure-Signalement
  - Eventy-Life-Politique-Accessibilite-PMR

Usage : python scripts/garanties/conformite-ethique-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Politique-Anti-Corruption.docx",
     "pdf":  "docs/garanties/Eventy-Life-Politique-Anti-Corruption.pdf",
     "footer": "EVENTY LIFE SAS — Politique anti-corruption"},
    {"docx": "docs/garanties/Eventy-Life-Procedure-Signalement.docx",
     "pdf":  "docs/garanties/Eventy-Life-Procedure-Signalement.pdf",
     "footer": "EVENTY LIFE SAS — Procédure signalement · Confidentielle"},
    {"docx": "docs/garanties/Eventy-Life-Politique-Accessibilite-PMR.docx",
     "pdf":  "docs/garanties/Eventy-Life-Politique-Accessibilite-PMR.pdf",
