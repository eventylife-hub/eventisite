...
Convertit les 3 documents .docx en .pdf imprimables :
  - Eventy-Life-Charte-Valeurs-Ethique-Equipe
  - Eventy-Life-Plan-Education-Sensibilisation-Voyageurs
  - Eventy-Life-Plan-Prevention-Burnout

Usage : python scripts/garanties/valeurs-sensibilisation-burnout-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Charte-Valeurs-Ethique-Equipe.docx",
     "pdf":  "docs/garanties/Eventy-Life-Charte-Valeurs-Ethique-Equipe.pdf",
     "footer": "EVENTY LIFE SAS — Charte valeurs et éthique équipe"},
    {"docx": "docs/garanties/Eventy-Life-Plan-Education-Sensibilisation-Voyageurs.docx",
     "pdf":  "docs/garanties/Eventy-Life-Plan-Education-Sensibilisation-Voyageurs.pdf",
     "footer": "EVENTY LIFE SAS — Plan éducation voyageurs"},
    {"docx": "docs/garanties/Eventy-Life-Plan-Prevention-Burnout.docx",
     "pdf":  "docs/garanties/Eventy-Life-Plan-Prevention-Burnout.pdf",
