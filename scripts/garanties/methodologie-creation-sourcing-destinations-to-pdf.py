...
Convertit les 3 documents .docx en .pdf imprimables :
  - Eventy-Life-Methodologie-Creation-Voyage
  - Eventy-Life-Procedure-Sourcing-HRA
  - Eventy-Life-Grille-Decision-Destinations

Usage : python scripts/garanties/methodologie-creation-sourcing-destinations-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Methodologie-Creation-Voyage.docx",
     "pdf":  "docs/garanties/Eventy-Life-Methodologie-Creation-Voyage.pdf",
     "footer": "EVENTY LIFE SAS — Méthodologie création voyage"},
    {"docx": "docs/garanties/Eventy-Life-Procedure-Sourcing-HRA.docx",
     "pdf":  "docs/garanties/Eventy-Life-Procedure-Sourcing-HRA.pdf",
     "footer": "EVENTY LIFE SAS — Procédure sourcing HRA"},
    {"docx": "docs/garanties/Eventy-Life-Grille-Decision-Destinations.docx",
     "pdf":  "docs/garanties/Eventy-Life-Grille-Decision-Destinations.pdf",
