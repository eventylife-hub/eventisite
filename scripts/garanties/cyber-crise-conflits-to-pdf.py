...
Convertit les 3 documents .docx en .pdf imprimables :
  - Eventy-Life-Politique-Cybersecurite
  - Eventy-Life-Procedure-Crise-Communication
  - Eventy-Life-Politique-Conflits-Interets

Usage : python scripts/garanties/cyber-crise-conflits-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Politique-Cybersecurite.docx",
     "pdf":  "docs/garanties/Eventy-Life-Politique-Cybersecurite.pdf",
     "footer": "EVENTY LIFE SAS — Politique cybersécurité · Confidentielle"},
    {"docx": "docs/garanties/Eventy-Life-Procedure-Crise-Communication.docx",
     "pdf":  "docs/garanties/Eventy-Life-Procedure-Crise-Communication.pdf",
     "footer": "EVENTY LIFE SAS — Procédure crise communication · Confidentielle"},
    {"docx": "docs/garanties/Eventy-Life-Politique-Conflits-Interets.docx",
     "pdf":  "docs/garanties/Eventy-Life-Politique-Conflits-Interets.pdf",
...
FOOTER = '<div id="footer_content">{footer} · Page <span class="pagenumber"></span> / <span class="pagecount"></span> · 1er mai 2026</div>'
