...
Convertit les 3 documents .docx en .pdf imprimables :
  - Eventy-Life-Politique-Open-Source-PI
  - Eventy-Life-Plan-Communication-Interne
  - Eventy-Life-Procedure-Amelioration-Continue

Usage : python scripts/garanties/opensource-comm-interne-amelioration-continue-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Politique-Open-Source-PI.docx",
     "pdf":  "docs/garanties/Eventy-Life-Politique-Open-Source-PI.pdf",
     "footer": "EVENTY LIFE SAS — Politique open source et PI"},
    {"docx": "docs/garanties/Eventy-Life-Plan-Communication-Interne.docx",
     "pdf":  "docs/garanties/Eventy-Life-Plan-Communication-Interne.pdf",
     "footer": "EVENTY LIFE SAS — Plan de communication interne"},
    {"docx": "docs/garanties/Eventy-Life-Procedure-Amelioration-Continue.docx",
     "pdf":  "docs/garanties/Eventy-Life-Procedure-Amelioration-Continue.pdf",
