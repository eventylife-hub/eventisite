...
Convertit les 3 documents .docx en .pdf imprimables :
  - Eventy-Life-Plan-Strategique-5-Ans
  - Eventy-Life-Plan-Etudes-Veille-Marche
  - Eventy-Life-Politique-Image-Droit

Usage : python scripts/garanties/strategique-etudes-droit-image-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Plan-Strategique-5-Ans.docx",
     "pdf":  "docs/garanties/Eventy-Life-Plan-Strategique-5-Ans.pdf",
     "footer": "EVENTY LIFE SAS — Plan stratégique 5 ans"},
    {"docx": "docs/garanties/Eventy-Life-Plan-Etudes-Veille-Marche.docx",
     "pdf":  "docs/garanties/Eventy-Life-Plan-Etudes-Veille-Marche.pdf",
     "footer": "EVENTY LIFE SAS — Plan d'études et veille marché"},
    {"docx": "docs/garanties/Eventy-Life-Politique-Image-Droit.docx",
     "pdf":  "docs/garanties/Eventy-Life-Politique-Image-Droit.pdf",
