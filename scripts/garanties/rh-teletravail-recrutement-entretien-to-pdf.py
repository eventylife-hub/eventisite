...
Convertit les 3 documents .docx en .pdf imprimables :
  - Eventy-Life-Charte-Teletravail
  - Eventy-Life-Procedure-Recrutement
  - Eventy-Life-Modele-Entretien-Annuel

Usage : python scripts/garanties/rh-teletravail-recrutement-entretien-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Charte-Teletravail.docx",
     "pdf":  "docs/garanties/Eventy-Life-Charte-Teletravail.pdf",
     "footer": "EVENTY LIFE SAS — Charte télétravail"},
    {"docx": "docs/garanties/Eventy-Life-Procedure-Recrutement.docx",
     "pdf":  "docs/garanties/Eventy-Life-Procedure-Recrutement.pdf",
     "footer": "EVENTY LIFE SAS — Procédure recrutement et intégration"},
    {"docx": "docs/garanties/Eventy-Life-Modele-Entretien-Annuel.docx",
     "pdf":  "docs/garanties/Eventy-Life-Modele-Entretien-Annuel.pdf",
