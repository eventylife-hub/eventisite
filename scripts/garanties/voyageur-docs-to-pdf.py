"""
Convertit les 3 documents voyageur .docx en .pdf imprimables :
  - Eventy-Life-Politique-Confidentialite-RGPD
  - Eventy-Life-Politique-Cookies
  - Eventy-Life-Information-Precontractuelle

Usage : python scripts/garanties/voyageur-docs-to-pdf.py
"""
import sys
import os
import mammoth
...
DOCS = [
    {
        "docx": "docs/garanties/Eventy-Life-Politique-Confidentialite-RGPD.docx",
        "pdf":  "docs/garanties/Eventy-Life-Politique-Confidentialite-RGPD.pdf",
        "footer": "EVENTY LIFE SAS — Politique de Confidentialité RGPD",
    },
    {
        "docx": "docs/garanties/Eventy-Life-Politique-Cookies.docx",
        "pdf":  "docs/garanties/Eventy-Life-Politique-Cookies.pdf",
        "footer": "EVENTY LIFE SAS — Politique Cookies",
    },
    {
        "docx": "docs/garanties/Eventy-Life-Information-Precontractuelle.docx",
        "pdf":  "docs/garanties/Eventy-Life-Information-Precontractuelle.pdf",
