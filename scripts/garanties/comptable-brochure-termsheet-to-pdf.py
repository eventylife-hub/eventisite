...
Convertit les 3 documents complémentaires .docx en .pdf imprimables :
  - Eventy-Life-Note-Expert-Comptable
  - Eventy-Life-Brochure-Commerciale
  - Eventy-Life-Term-Sheet-Seed

Usage : python scripts/garanties/comptable-brochure-termsheet-to-pdf.py
"""
import sys
import os
import mammoth
...
DOCS = [
    {
        "docx": "docs/garanties/Eventy-Life-Note-Expert-Comptable.docx",
        "pdf":  "docs/garanties/Eventy-Life-Note-Expert-Comptable.pdf",
        "footer": "EVENTY LIFE SAS — Note expert-comptable · Confidentiel",
    },
    {
        "docx": "docs/garanties/Eventy-Life-Brochure-Commerciale.docx",
        "pdf":  "docs/garanties/Eventy-Life-Brochure-Commerciale.pdf",
        "footer": "EVENTY LIFE SAS — Brochure commerciale",
    },
    {
        "docx": "docs/garanties/Eventy-Life-Term-Sheet-Seed.docx",
        "pdf":  "docs/garanties/Eventy-Life-Term-Sheet-Seed.pdf",
