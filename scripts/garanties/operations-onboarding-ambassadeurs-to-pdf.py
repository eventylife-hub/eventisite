...
Convertit les 3 documents .docx en .pdf imprimables :
  - Eventy-Life-Manuel-Operations-Quotidiennes
  - Eventy-Life-Onboarding-Voyageur
  - Eventy-Life-Code-Conduite-Ambassadeurs

Usage : python scripts/garanties/operations-onboarding-ambassadeurs-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Manuel-Operations-Quotidiennes.docx",
     "pdf":  "docs/garanties/Eventy-Life-Manuel-Operations-Quotidiennes.pdf",
     "footer": "EVENTY LIFE SAS — Manuel opérations quotidiennes · Confidentiel"},
    {"docx": "docs/garanties/Eventy-Life-Onboarding-Voyageur.docx",
     "pdf":  "docs/garanties/Eventy-Life-Onboarding-Voyageur.pdf",
     "footer": "EVENTY LIFE SAS — Onboarding voyageur"},
    {"docx": "docs/garanties/Eventy-Life-Code-Conduite-Ambassadeurs.docx",
     "pdf":  "docs/garanties/Eventy-Life-Code-Conduite-Ambassadeurs.pdf",
