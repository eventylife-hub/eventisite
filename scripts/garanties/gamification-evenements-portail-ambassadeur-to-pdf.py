...
Convertit les 3 documents .docx en .pdf imprimables :
  - Eventy-Life-Programme-Gamification-Voyageur
  - Eventy-Life-Plan-Evenements
  - Eventy-Life-Guide-Portail-Ambassadeur

Usage : python scripts/garanties/gamification-evenements-portail-ambassadeur-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Programme-Gamification-Voyageur.docx",
     "pdf":  "docs/garanties/Eventy-Life-Programme-Gamification-Voyageur.pdf",
     "footer": "EVENTY LIFE SAS — Programme gamification voyageur"},
    {"docx": "docs/garanties/Eventy-Life-Plan-Evenements.docx",
     "pdf":  "docs/garanties/Eventy-Life-Plan-Evenements.pdf",
     "footer": "EVENTY LIFE SAS — Plan d'événements"},
    {"docx": "docs/garanties/Eventy-Life-Guide-Portail-Ambassadeur.docx",
     "pdf":  "docs/garanties/Eventy-Life-Guide-Portail-Ambassadeur.pdf",
