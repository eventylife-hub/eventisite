...
Convertit les 3 documents .docx en .pdf imprimables :
  - Eventy-Life-Plan-Accessibilite-Numerique
  - Eventy-Life-Roadmap-Technique
  - Eventy-Life-Guide-Espace-Voyageur

Usage : python scripts/garanties/tech-accessibilite-roadmap-espace-voyageur-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Plan-Accessibilite-Numerique.docx",
     "pdf":  "docs/garanties/Eventy-Life-Plan-Accessibilite-Numerique.pdf",
     "footer": "EVENTY LIFE SAS — Plan accessibilité numérique"},
    {"docx": "docs/garanties/Eventy-Life-Roadmap-Technique.docx",
     "pdf":  "docs/garanties/Eventy-Life-Roadmap-Technique.pdf",
     "footer": "EVENTY LIFE SAS — Roadmap technique"},
    {"docx": "docs/garanties/Eventy-Life-Guide-Espace-Voyageur.docx",
     "pdf":  "docs/garanties/Eventy-Life-Guide-Espace-Voyageur.pdf",
