...
Convertit les 3 documents .docx en .pdf imprimables :
  - Eventy-Life-Documentation-API-Publique
  - Eventy-Life-Charte-Commerciale
  - Eventy-Life-Plan-Gestion-Stocks-Ressources

Usage : python scripts/garanties/api-charte-commerciale-stocks-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Documentation-API-Publique.docx",
     "pdf":  "docs/garanties/Eventy-Life-Documentation-API-Publique.pdf",
     "footer": "EVENTY LIFE SAS — Documentation API publique"},
    {"docx": "docs/garanties/Eventy-Life-Charte-Commerciale.docx",
     "pdf":  "docs/garanties/Eventy-Life-Charte-Commerciale.pdf",
     "footer": "EVENTY LIFE SAS — Charte commerciale"},
    {"docx": "docs/garanties/Eventy-Life-Plan-Gestion-Stocks-Ressources.docx",
     "pdf":  "docs/garanties/Eventy-Life-Plan-Gestion-Stocks-Ressources.pdf",
