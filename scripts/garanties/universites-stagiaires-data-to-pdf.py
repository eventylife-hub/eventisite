...
Convertit les 3 documents .docx en .pdf imprimables :
  ...
  - Eventy-Life-Politique-Stagiaires-Alternants
  - Eventy-Life-Politique-Valorisation-Donnees

Usage : python scripts/garanties/universites-stagiaires-data-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Plan-Partenariat-Universitaire.docx",
     "pdf":  "docs/garanties/Eventy-Life-Plan-Partenariat-Universitaire.pdf",
     "footer": "EVENTY LIFE SAS — Plan partenariat universitaire"},
    {"docx": "docs/garanties/Eventy-Life-Politique-Stagiaires-Alternants.docx",
     "pdf":  "docs/garanties/Eventy-Life-Politique-Stagiaires-Alternants.pdf",
     "footer": "EVENTY LIFE SAS — Politique stagiaires et alternants"},
    {"docx": "docs/garanties/Eventy-Life-Politique-Valorisation-Donnees.docx",
     "pdf":  "docs/garanties/Eventy-Life-Politique-Valorisation-Donnees.pdf",
