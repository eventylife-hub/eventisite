...
Convertit les 3 documents .docx en .pdf imprimables :
  - Eventy-Life-Guide-TVA-Marge-Tourisme
  - Eventy-Life-Plan-Comptable-Processus
  - Eventy-Life-Plan-Audit-Interne

Usage : python scripts/garanties/tva-marge-comptable-audit-interne-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Guide-TVA-Marge-Tourisme.docx",
     "pdf":  "docs/garanties/Eventy-Life-Guide-TVA-Marge-Tourisme.pdf",
     "footer": "EVENTY LIFE SAS — Guide TVA marge tourisme"},
    {"docx": "docs/garanties/Eventy-Life-Plan-Comptable-Processus.docx",
     "pdf":  "docs/garanties/Eventy-Life-Plan-Comptable-Processus.pdf",
     "footer": "EVENTY LIFE SAS — Plan comptable et processus"},
    {"docx": "docs/garanties/Eventy-Life-Plan-Audit-Interne.docx",
     "pdf":  "docs/garanties/Eventy-Life-Plan-Audit-Interne.pdf",
