...
Convertit les 3 documents .docx en .pdf imprimables :
  - Eventy-Life-Charte-Engagement-Carbone
  - Eventy-Life-Politique-Achats-Responsables
  - Eventy-Life-Plan-Mobilite-Durable

Usage : python scripts/garanties/rse-carbone-achats-mobilite-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Charte-Engagement-Carbone.docx",
     "pdf":  "docs/garanties/Eventy-Life-Charte-Engagement-Carbone.pdf",
     "footer": "EVENTY LIFE SAS — Charte engagement carbone"},
    {"docx": "docs/garanties/Eventy-Life-Politique-Achats-Responsables.docx",
     "pdf":  "docs/garanties/Eventy-Life-Politique-Achats-Responsables.pdf",
     "footer": "EVENTY LIFE SAS — Politique achats responsables"},
    {"docx": "docs/garanties/Eventy-Life-Plan-Mobilite-Durable.docx",
     "pdf":  "docs/garanties/Eventy-Life-Plan-Mobilite-Durable.pdf",
