"""
Convertit les 3 documents juridiques corporate .docx en .pdf imprimables :
  - Eventy-Life-Statuts-SAS
  - Eventy-Life-Pacte-Associes-Seed
  - Eventy-Life-Onboarding-Partenaires

Usage : python scripts/garanties/juridique-corporate-to-pdf.py
"""
import sys
import os
import mammoth
...
DOCS = [
    {
        "docx": "docs/garanties/Eventy-Life-Statuts-SAS.docx",
        "pdf":  "docs/garanties/Eventy-Life-Statuts-SAS.pdf",
        "footer": "EVENTY LIFE SAS — Statuts",
    },
    {
        "docx": "docs/garanties/Eventy-Life-Pacte-Associes-Seed.docx",
        "pdf":  "docs/garanties/Eventy-Life-Pacte-Associes-Seed.pdf",
        "footer": "EVENTY LIFE SAS — Pacte d'associés type Seed",
    },
    {
        "docx": "docs/garanties/Eventy-Life-Onboarding-Partenaires.docx",
        "pdf":  "docs/garanties/Eventy-Life-Onboarding-Partenaires.pdf",
