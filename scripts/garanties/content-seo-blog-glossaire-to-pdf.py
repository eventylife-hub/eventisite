...
Convertit les 3 documents .docx en .pdf imprimables :
  ...
  - Eventy-Life-Ligne-Editoriale-Blog
  - Eventy-Life-Glossaire-Voyage

Usage : python scripts/garanties/content-seo-blog-glossaire-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Guide-SEO.docx",
     "pdf":  "docs/garanties/Eventy-Life-Guide-SEO.pdf",
     "footer": "EVENTY LIFE SAS — Guide SEO"},
    {"docx": "docs/garanties/Eventy-Life-Ligne-Editoriale-Blog.docx",
     "pdf":  "docs/garanties/Eventy-Life-Ligne-Editoriale-Blog.pdf",
     "footer": "EVENTY LIFE SAS — Ligne éditoriale blog"},
    {"docx": "docs/garanties/Eventy-Life-Glossaire-Voyage.docx",
     "pdf":  "docs/garanties/Eventy-Life-Glossaire-Voyage.pdf",
