...
Convertit les 3 documents .docx en .pdf imprimables :
  - Eventy-Life-Plan-Expansion-Internationale
  - Eventy-Life-Strategie-Relations-Presse
  - Eventy-Life-Plan-Partenariats-Institutionnels

Usage : python scripts/garanties/strategie-expansion-rp-partenariats-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Plan-Expansion-Internationale.docx",
     "pdf":  "docs/garanties/Eventy-Life-Plan-Expansion-Internationale.pdf",
     "footer": "EVENTY LIFE SAS — Plan expansion internationale"},
    {"docx": "docs/garanties/Eventy-Life-Strategie-Relations-Presse.docx",
     "pdf":  "docs/garanties/Eventy-Life-Strategie-Relations-Presse.pdf",
     "footer": "EVENTY LIFE SAS — Stratégie relations presse"},
    {"docx": "docs/garanties/Eventy-Life-Plan-Partenariats-Institutionnels.docx",
     "pdf":  "docs/garanties/Eventy-Life-Plan-Partenariats-Institutionnels.pdf",
