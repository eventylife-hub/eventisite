"""
Convertit le dossier Subventions Publiques .docx en .pdf imprimable.

Usage : python scripts/garanties/subventions-to-pdf.py
"""
import sys
import os
import mammoth
...
DOCX = "docs/garanties/Eventy-Life-Dossier-Subventions-Publiques.docx"
PDF = "docs/garanties/Eventy-Life-Dossier-Subventions-Publiques.pdf"
...
#header_content {
    ...
    color: #888888;
    text-align: right;
    border-bottom: 0.5pt solid #2C5F2D;
    padding-bottom: 2pt;
}
#footer_content {
    font-family: "Helvetica", "Arial", sans-serif;
...
HEADER_FOOTER = """
<div id="header_content">Eventy Life — Dossier Subventions Publiques · Confidentiel</div>
...
<head>
<meta charset="utf-8">
<title>Eventy Life — Dossier Subventions Publiques</title>
<style>{CSS}</style>
</head>
<body>
{HEADER_FOOTER}
