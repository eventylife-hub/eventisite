...
Convertit les 3 documents .docx en .pdf imprimables :
  - Eventy-Life-Charte-Qualite-Accompagnateur
  - Eventy-Life-Plan-Formation-Accompagnateur
  - Eventy-Life-Politique-Avis-Voyageurs

Usage : python scripts/garanties/charte-formation-avis-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Charte-Qualite-Accompagnateur.docx",
     "pdf":  "docs/garanties/Eventy-Life-Charte-Qualite-Accompagnateur.pdf",
     "footer": "EVENTY LIFE SAS — Charte qualité accompagnateur"},
    {"docx": "docs/garanties/Eventy-Life-Plan-Formation-Accompagnateur.docx",
     "pdf":  "docs/garanties/Eventy-Life-Plan-Formation-Accompagnateur.pdf",
     "footer": "EVENTY LIFE SAS — Plan formation accompagnateur"},
    {"docx": "docs/garanties/Eventy-Life-Politique-Avis-Voyageurs.docx",
     "pdf":  "docs/garanties/Eventy-Life-Politique-Avis-Voyageurs.pdf",
...
FOOTER = '<div id="footer_content">{footer} · Page <span class="pagenumber"></span> / <span class="pagecount"></span> · 30 avril 2026</div>'
...
{result.value}
    ...
    if ps.err:
        print(f"ERREUR pisa : {ps.err}", file=sys.stderr)
        sys.exit(1)
