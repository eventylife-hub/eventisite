...
Convertit les 3 documents .docx en .pdf imprimables :
  - Eventy-Life-Charte-Fournisseurs
  - Eventy-Life-Procedure-Audit-Qualite-HRA
  - Eventy-Life-Tableau-Bord-Operationnel

Usage : python scripts/garanties/charte-audit-tableaubord-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Charte-Fournisseurs.docx",
     "pdf":  "docs/garanties/Eventy-Life-Charte-Fournisseurs.pdf",
     "footer": "EVENTY LIFE SAS — Charte fournisseurs"},
    {"docx": "docs/garanties/Eventy-Life-Procedure-Audit-Qualite-HRA.docx",
     "pdf":  "docs/garanties/Eventy-Life-Procedure-Audit-Qualite-HRA.pdf",
     "footer": "EVENTY LIFE SAS — Procédure audit qualité HRA"},
    {"docx": "docs/garanties/Eventy-Life-Tableau-Bord-Operationnel.docx",
     "pdf":  "docs/garanties/Eventy-Life-Tableau-Bord-Operationnel.pdf",
