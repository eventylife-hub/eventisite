...
Convertit les 3 documents .docx en .pdf imprimables :
  - Eventy-Life-Plan-Experimentation
  - Eventy-Life-Politique-Sponsoring-Mecenat
  - Eventy-Life-Methodologie-Animation-Accompagnateur

Usage : python scripts/garanties/experimentation-sponsoring-animation-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Plan-Experimentation.docx",
     "pdf":  "docs/garanties/Eventy-Life-Plan-Experimentation.pdf",
     "footer": "EVENTY LIFE SAS — Plan d'expérimentation et tests"},
    {"docx": "docs/garanties/Eventy-Life-Politique-Sponsoring-Mecenat.docx",
     "pdf":  "docs/garanties/Eventy-Life-Politique-Sponsoring-Mecenat.pdf",
     "footer": "EVENTY LIFE SAS — Politique sponsoring et mécénat"},
    {"docx": "docs/garanties/Eventy-Life-Methodologie-Animation-Accompagnateur.docx",
     "pdf":  "docs/garanties/Eventy-Life-Methodologie-Animation-Accompagnateur.pdf",
