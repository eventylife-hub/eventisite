...
Convertit les 3 documents .docx en .pdf imprimables :
  - Eventy-Life-Document-Banque-Domiciliataire
  - Eventy-Life-Plan-Continuite-Activite
  - Eventy-Life-Dossier-Presse

Usage : python scripts/garanties/banque-pca-presse-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Document-Banque-Domiciliataire.docx",
     "pdf":  "docs/garanties/Eventy-Life-Document-Banque-Domiciliataire.pdf",
     "footer": "EVENTY LIFE SAS — Document banque domiciliataire · Confidentiel"},
    {"docx": "docs/garanties/Eventy-Life-Plan-Continuite-Activite.docx",
     "pdf":  "docs/garanties/Eventy-Life-Plan-Continuite-Activite.pdf",
     "footer": "EVENTY LIFE SAS — Plan de Continuité d'Activité"},
    {"docx": "docs/garanties/Eventy-Life-Dossier-Presse.docx",
     "pdf":  "docs/garanties/Eventy-Life-Dossier-Presse.pdf",
