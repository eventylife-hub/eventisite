...
Convertit les 3 documents .docx en .pdf imprimables :
  - Eventy-Life-Politique-Make-Buy
  - Eventy-Life-Politique-Gestion-Documentaire
  - Eventy-Life-Charte-UGC

Usage : python scripts/garanties/makebuy-gestion-doc-ugc-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Politique-Make-Buy.docx",
     "pdf":  "docs/garanties/Eventy-Life-Politique-Make-Buy.pdf",
     "footer": "EVENTY LIFE SAS — Politique make/buy"},
    {"docx": "docs/garanties/Eventy-Life-Politique-Gestion-Documentaire.docx",
     "pdf":  "docs/garanties/Eventy-Life-Politique-Gestion-Documentaire.pdf",
     "footer": "EVENTY LIFE SAS — Politique gestion documentaire"},
    {"docx": "docs/garanties/Eventy-Life-Charte-UGC.docx",
     "pdf":  "docs/garanties/Eventy-Life-Charte-UGC.pdf",
