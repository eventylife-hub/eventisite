...
Convertit les 3 documents .docx en .pdf imprimables :
  - Eventy-Life-Charte-Mineurs-Voyageurs
  - Eventy-Life-Politique-Notes-De-Frais
  - Eventy-Life-Plan-Gestion-Env-Destinations

Usage : python scripts/garanties/mineurs-notes-frais-env-destinations-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Charte-Mineurs-Voyageurs.docx",
     "pdf":  "docs/garanties/Eventy-Life-Charte-Mineurs-Voyageurs.pdf",
     "footer": "EVENTY LIFE SAS — Charte mineurs voyageurs"},
    {"docx": "docs/garanties/Eventy-Life-Politique-Notes-De-Frais.docx",
     "pdf":  "docs/garanties/Eventy-Life-Politique-Notes-De-Frais.pdf",
     "footer": "EVENTY LIFE SAS — Politique notes de frais"},
    {"docx": "docs/garanties/Eventy-Life-Plan-Gestion-Env-Destinations.docx",
     "pdf":  "docs/garanties/Eventy-Life-Plan-Gestion-Env-Destinations.pdf",
