...
Convertit les 3 documents .docx en .pdf imprimables :
  - Eventy-Life-Charte-Inclusion-Diversite
  - Eventy-Life-Plan-Voyageurs-Mysteres
  - Eventy-Life-Manuel-Voyageur-Autonome

Usage : python scripts/garanties/inclusion-voyageurs-mysteres-manuel-voyageur-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Charte-Inclusion-Diversite.docx",
     "pdf":  "docs/garanties/Eventy-Life-Charte-Inclusion-Diversite.pdf",
     "footer": "EVENTY LIFE SAS — Charte inclusion et diversité"},
    {"docx": "docs/garanties/Eventy-Life-Plan-Voyageurs-Mysteres.docx",
     "pdf":  "docs/garanties/Eventy-Life-Plan-Voyageurs-Mysteres.pdf",
     "footer": "EVENTY LIFE SAS — Plan voyageurs-mystères"},
    {"docx": "docs/garanties/Eventy-Life-Manuel-Voyageur-Autonome.docx",
     "pdf":  "docs/garanties/Eventy-Life-Manuel-Voyageur-Autonome.pdf",
