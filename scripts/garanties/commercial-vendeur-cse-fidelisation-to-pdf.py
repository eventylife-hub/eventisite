...
Convertit les 3 documents .docx en .pdf imprimables :
  - Eventy-Life-Argumentaire-Vendeurs
  - Eventy-Life-Offre-CSE-B2B
  - Eventy-Life-Programme-Fidelisation-Famille

Usage : python scripts/garanties/commercial-vendeur-cse-fidelisation-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Argumentaire-Vendeurs.docx",
     "pdf":  "docs/garanties/Eventy-Life-Argumentaire-Vendeurs.pdf",
     "footer": "EVENTY LIFE SAS — Argumentaire vendeurs · Confidentiel"},
    {"docx": "docs/garanties/Eventy-Life-Offre-CSE-B2B.docx",
     "pdf":  "docs/garanties/Eventy-Life-Offre-CSE-B2B.pdf",
     "footer": "EVENTY LIFE SAS — Offre CSE et B2B"},
    {"docx": "docs/garanties/Eventy-Life-Programme-Fidelisation-Famille.docx",
     "pdf":  "docs/garanties/Eventy-Life-Programme-Fidelisation-Famille.pdf",
