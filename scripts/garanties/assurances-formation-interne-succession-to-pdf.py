...
Convertit les 3 documents .docx en .pdf imprimables :
  - Eventy-Life-Politique-Assurance-Globale
  - Eventy-Life-Plan-Formation-Interne
  - Eventy-Life-Plan-Succession-Dirigeant

Usage : python scripts/garanties/assurances-formation-interne-succession-to-pdf.py
"""
import sys, os
import mammoth
...
DOCS = [
    {"docx": "docs/garanties/Eventy-Life-Politique-Assurance-Globale.docx",
     "pdf":  "docs/garanties/Eventy-Life-Politique-Assurance-Globale.pdf",
     "footer": "EVENTY LIFE SAS — Politique assurance globale"},
    {"docx": "docs/garanties/Eventy-Life-Plan-Formation-Interne.docx",
     "pdf":  "docs/garanties/Eventy-Life-Plan-Formation-Interne.pdf",
     "footer": "EVENTY LIFE SAS — Plan formation interne équipe"},
    {"docx": "docs/garanties/Eventy-Life-Plan-Succession-Dirigeant.docx",
     "pdf":  "docs/garanties/Eventy-Life-Plan-Succession-Dirigeant.pdf",
